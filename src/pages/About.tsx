              ...
              <div className="relative flex w-full flex-col">
                ...
                <div className="p-6">
                  ...
                  <p className="text-lg sm:text-xl montserrat text-gray-400 mt-5">
                    We are a web development and design agency created by
                    talented developers with high hopes. We chose the name
                    `retwiz` because it symbolizes a higher level of skill and
                    expertise, representing our agency's high standards and
                    achievements in design and development.
                  </p>
                </div>
                <div className="p-6">
                  <h1
                  ...
                  <p className="text-lg sm:text-xl montserrat text-gray-400 mt-5">
                    At retwiz, we value creativity, innovation, and quality. We
                    believe in delivering the best possible solutions to our
                    clients and exceeding their expectations. We are committed
                    to providing exceptional customer service and building
                    strong relationships with our clients, and we are dedicated
                    to helping them succeed in the digital world.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative flex overflow-hidden bg-slate-800 shadow-xl rounded-xl dark:bg-slate-900/70 dark:ring-1 dark:ring-inset dark:ring-white/10 dark:backdrop-blur">
                <div className="relative flex w-full flex-col">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-lg sm:text-xl montserrat text-gray-400 mt-5">
                      Our mission is to provide our clients with the best
                      possible solutions for their needs. We strive to deliver
                      high-quality, innovative, and user-friendly websites and
                      applications that help our clients achieve their goals.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex overflow-hidden bg-slate-800 shadow-xl rounded-xl dark:bg-slate-900/70 dark:ring-1 dark:ring-inset dark:ring-white/10 dark:backdrop-blur">
                <div className="relative flex w-full flex-col">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-lg sm:text-xl montserrat text-gray-400 mt-5">
                      Our vision is to become a leading web development and
                      design agency that is known for its creativity,
                      innovation, and commitment to excellence. We aim to build
                      long-term relationships with our clients and help them
